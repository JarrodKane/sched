...
<div role="tablist" class="tabs tabs-border mb-6">
	<a role="tab" href={base} class="tab {isTab(base) && !isTab(`${base}/history`) && !isTab(`${base}/media`) && !isTab(`${base}/settings`) && !isTab(`${base}/tickets`) ? 'tab-active' : ''}">
		Schedule
	</a>
	...
	<a role="tab" href="{base}/tickets" class="tab {isTab(`${base}/tickets`) ? 'tab-active' : ''}">
		Tickets
	</a>
